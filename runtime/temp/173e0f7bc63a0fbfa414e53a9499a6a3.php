<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"D:\www\service\wx\admin\public/../application/admin\view\warning\add.html";i:1524217396;s:66:"D:\www\service\wx\admin\application\admin\view\layout\default.html";i:1524116523;s:63:"D:\www\service\wx\admin\application\admin\view\common\meta.html";i:1524116522;s:65:"D:\www\service\wx\admin\application\admin\view\common\script.html";i:1524126691;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-is_read" class="form-control" name="row[is_read]" type="text" value="0">
        </div>
    </div>
    <div class="form-group">
        <label for="c-read_time" class="control-label col-xs-12 col-sm-2"><?php echo __('Read_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-read_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[read_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-memo" class="control-label col-xs-12 col-sm-2"><?php echo __('Memo'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-memo" class="form-control " rows="5" name="row[memo]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
