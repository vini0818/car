...
class Backend extends Controller
{
     ...
     * 数据限制字段
     */
    protected $dataLimitField = 'village_id';
...
//                $this->error(__('Please login first'), url('index/login', ['url' => $url]));
        ...
        $config = [
            ...
            'msgserverurl'   => Config::get('msg_server_url'),
     ...
     * @param array $extendWheres 额外的查询条件
     * @return array
     */
    protected function buildparams($searchfields = null, $relationSearch = null, $extendWheres = null)
    {
    ...
    protected function getDataLimitAdminIds()
    {
        ...
        if ($this->auth->isSuperAdmin() || !array_intersect($groups, array(6, 7, 8)))
        {
            return null;
        }
        $villageIds = [];
        ...
        {
            $villageIds = $this->dataLimit == 'auth' ? $this->auth->getChildrenAdminIds(true) : $this->auth->getVillageIds();
        }
        return $villageIds;
    }
//    protected function getDataLimitAdminIds()
