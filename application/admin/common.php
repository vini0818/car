 ...
 * @param mixed $options    //取值数据[value=>title]
 * @param mixed $selected   //默认选中项的value值（多个用','分隔）
 * @param mixed $attr
 * @return string
 */
 ...
 * 生成单选按钮组
 * @param string $name      //字段名
 * @param array $list       //取值[value=>title]
 * @param mixed $selected   //默认选中项的value值
 * @return string
 */
...
/**
 * 生成用户session键名：幂等性（重复一致性）
 * 
 * @param int $user_id
 * @return string
 */
function create_user_session_key($user_id) {
    $salt = 'createin2018^duohe';
